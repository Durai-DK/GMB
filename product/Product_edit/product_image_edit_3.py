        ...
        for r1 in driver.find_elements(By.CLASS_NAME,'zTXfQc'):
            for r2 in r1.find_elements(By.CLASS_NAME,'TB4jmc'):
                for r3 in r2.find_elements(By.CLASS_NAME,"bgmvLc"):
                    print(r3.text)
                    if r3.text == "Samsung Galaxy Z Fold 4 5G":
                        r2.click()
                        time.sleep(3)

                        driver.implicitly_wait(10)
                        driver.find_element(By.CLASS_NAME, "ULhCdf").send_keys(r"D:\Durai\GMB\product\image\02-09-2022-2.jpeg")
                        time.sleep(5)
